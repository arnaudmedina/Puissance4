...
class Jeu {
	 ...
	 * série de 4 pions de la même couleur. Si une telle série existe, retourne
	 * true.
	 *
	 * Notez qu'il n'est pas nécessaire de retourner la couleur des 4 pions
	 * alignés, puisqu'il s'agit de celle de celui qui vient de jouer.
	 * 
	 ...
	 * définie par le point de départ, ou origine de coordonnées (oCol,oLigne),
	 * et par le déplacement delta (dCol,dLigne). En utilisant des valeurs
	 * appropriées pour dCol et dLigne on peut vérifier toutes les directions: -
	 * horizontale: dCol = 0, dLigne = 1 - vérticale: dCol = 1, dLigne = 0 -
	 * 1ère diagonale: dCol = 1, dLigne = 1 - 2ème diagonale: dCol = 1, dLigne =
	 * -1
	 *
	 * @param oCol
	 ...
	 * @param dCol
	 *            Delta de déplacement sur une colonne
	 * @param dLigne
	 *            Delta de déplacement sur une ligne
